...
def tauxReussite(etu, listExo):
    fichier = m.lectureJson("662cfbebea6d4042934526197165d805_instructions.json")
...
if __name__ == '__main__':
    ...
    fichier_in = m.lectureJson("662cfbebea6d4042934526197165d805_instructions.json")
    ...
    for nomEtu in listeEtu:
        listReussite = []
        listExo = m.listExoUser(nomEtu, fichier_vm)
        val,tauxR = tauxReussite(nomEtu,m.listExoUser(nomEtu, fichier_vm))
